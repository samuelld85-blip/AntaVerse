...
export const questions = [
  ...
  q({
    ...
    questionText:
      "Quels sont les neuf premiers nombres distincts de la suite de Fibonacci, en partant de 1 ?",
    answers: ["1", "2", "3", "5", "8", "13", "21", "34", "55"],
    sources: [OEIS("oeis-fibonacci", "Fibonacci numbers", "A000045")],
    exclusionNotes:
      "La seconde occurrence de 1 n’est pas répétée puisque la question demande des valeurs distinctes.",
  }),
  q({
    ...
    questionText:
      "Quels sont les neuf acides aminés essentiels chez l’adulte humain en bonne santé ?",
    answers: [
      "Histidine",
      "Isoleucine",
      "Leucine",
  ...
  q({
    ...
    questionText:
      "Quelles sont les neuf missions Apollo habitées ayant atteint le voisinage de la Lune ?",
    answers: [
      "Apollo 8",
      "Apollo 10",
      "Apollo 11",
    ...
    sources: [NASA_APOLLO],
    exclusionNotes:
      "Apollo 9 est restée en orbite terrestre ; Apollo 13 a atteint la Lune sans s’y poser.",
  }),
  q({
    ...
    sources: [NIST],
    qualificationRule:
      "Sont retenues les neuf cases de grandeurs définies dans le tableau 12 du chapitre 8 du guide SI du NIST.",
  }),
  q({
  ...
  q({
    ...
    questionText:
      "Quelles sont les neuf limites planétaires du cadre scientifique actualisé en 2023 ?",
    answers: [
      "Changement climatique",
      "Intégrité de la biosphère",
      "Changement d’usage des sols",
      "Modification de l’eau douce",
      "Flux biogéochimiques",
      "Acidification des océans",
      "Charge en aérosols atmosphériques",
