...
- `src/games/quoi-de-9/`, `src/games/la-relance/`, `src/games/sans-le-dire/`, `src/games/purple/` et `src/games/triman/` contiennent les moteurs, données, composants et styles propres à chaque jeu.
...
Les données persistantes restent isolées par les préfixes `qui-des-9:`, `la-relance:`, `sans-le-dire:`, `purple:` et `triman:`.
