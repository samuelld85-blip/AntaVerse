// Circular player-order helpers, local to this game (see Triman's own copy
// of the same shapes — ARCHITECTURE.md keeps per-game rules engines
// independent rather than forcing a shared abstraction for two callers that
